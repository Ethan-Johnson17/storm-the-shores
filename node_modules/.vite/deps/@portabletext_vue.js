...
// node_modules/@portabletext/vue/dist/vue-portable-text.mjs
function S(e, n) {
  var t = Object.keys(e);
...
function D(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? S(Object(t), true).forEach(function(r) {
      q(e, r, t[r]);
...
function q(e, n, t) {
  return n = R(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function R(e) {
  var n = z(e, "string");
...
function we(e) {
  ...
  return n.forEach((r, c) => {
    ...
    r.children.forEach((s) => {
      x(s) ? (t += i && t && !Z.test(t) && !Y.test(s.text) ? " " : "", t += s.text, i = false) : i = true;
    }), c !== n.length - 1 && (t += `
...
var y = (e) => (n, { slots: t }) => {
  var r;
  return h(e, (r = t.default) == null ? void 0 : r.call(t));
};
var ne = ({ value: e }, { slots: n }) => {
  var t;
  return h("a", { href: e == null ? void 0 : e.href }, (t = n.default) == null ? void 0 : t.call(n));
};
var re = { textDecoration: "underline" };
var ie = {
  code: y("code"),
  em: y("em"),
  link: ne,
  ...
  underline: (e, { slots: n }) => {
    var t;
    return h("span", { style: re }, (t = n.default) == null ? void 0 : t.call(n));
  }
};
var le = {
  number: y("ol"),
...
var oe = y("li");
var T = (e, n) => `[@portabletext/vue] Unknown ${e}, specify a component for it in the \`components.${n}\` prop`;
var C = (e) => T(`block type "${e}"`, "types");
var se = (e) => T(`mark type "${e}"`, "marks");
var ce = (e) => T(`block style "${e}"`, "block");
var ue = (e) => T(`list style "${e}"`, "list");
var ae = (e) => T(`list item style "${e}"`, "listItem");
function fe(e) {
  console.warn(e);
}
var M = { display: "none" };
var ye = ({
  ...
  const t = C(e._type);
  return n ? h("span", { style: M }, t) : h("div", { style: M }, t);
};
var pe = ({ markType: e }, { slots: n }) => {
  var t;
  return h("span", { class: `unknown__pt__mark__${e}` }, (t = n.default) == null ? void 0 : t.call(n));
};
var ke = y("p");
var he = y("ul");
var de = y("li");
...
var be = (e, n) => {
  ...
  function c(l, o, u) {
    const p = j({ node: l, index: o, isInline: false, renderNode: t }), a = e.listItem, g = (typeof a == "function" ? a : a[l.listItem]) || e.unknownListItem;
  ...
  function i(l, o, u) {
    const p = l.children.map(
      (h2, _) => t({
        node: h2._key ? h2 : { ...h2, _key: `li-${o}-${_}` },
        index: _,
        isInline: false,
        renderNode: t
      })
  ...
  function s(l, o, u) {
    const { markDef: p, markType: a, markKey: m } = l, g = e.marks[a] || e.unknownMark, h2 = l.children.map(
      (_, I) => t({ node: _, index: I, isInline: true, renderNode: t })
    );
  ...
  function f(l, o, u, p) {
    const { _key: a, children: m, ...g } = j({
      ...
      isInline: p,
      renderNode: t
    }), h2 = g.node.style || "normal", I = (typeof e.block == "function" ? e.block : e.block[h2]) || e.unknownBlockStyle;
    return I === e.unknownBlockStyle && n(ce(h2), {
      nodeType: "blockStyle",
      type: h2
    }), h(I, { key: u, ...g, value: g.node, renderNode: t }, () => m);
  }
  function d(l, o) {
    if (l.text === `
`) {
...
`;
  ...
  function b(l, o, u, p) {
    ...
    return m ? h(m, { key: u, ...a }) : void 0;
  }
  return t;
};
function j(e) {
  const { node: n, index: t, isInline: r, renderNode: c } = e, s = J(n).map(
    (f, d) => c({ node: f, isInline: true, index: d, renderNode: c })
  );
  return {
    _key: n._key || `block-${t}`,
    children: s,
...
var ve = defineComponent({
  ...
  setup(e) {
    ...
    const t = e, r = () => {
      ...
      return s.map(
        (b, l) => d({ node: b, index: l, isInline: false, renderNode: d })
      );
    };
    return (c, i) => (openBlock(), createBlock(r));
  }
});
export {
  ve as PortableText,
...
//# sourceMappingURL=@portabletext_vue.js.map
