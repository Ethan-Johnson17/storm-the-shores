...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-5LUR4IG6.js")
});
...
var PaneHeaderActions = (0, import_react.memo)(function(props) {
  const {
    initialValueTemplateItems: initialValueTemplateItemsFromStructure = EMPTY_ARRAY$x,
    menuItems = EMPTY_ARRAY$x,
    menuItemGroups = EMPTY_ARRAY$x,
            ...
            children: [
              activeView.type === "form" && !isPermissionsLoading && ready && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                (0, import_jsx_runtime.jsx)(
                  ...
                  {
                    granted: !!(permissions == null ? void 0 : permissions.granted),
                    requiredPermission
                  }
                ),
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema = useSchema(), templates = useTemplates(), { setDocumentMeta } = useCopyPaste(), {
    ...
    () => params.path ? fromString(params.path) : EMPTY_ARRAY$x
  ...
  const currentInspector = inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i) => i.name === HISTORY_INSPECTOR_NAME), changesOpen = (currentInspector == null ? void 0 : currentInspector.name) === HISTORY_INSPECTOR_NAME, { t } = useTranslation2(structureLocaleNamespace), inspectOpen = params.inspect === "on", compareValue = changesOpen ? sinceAttributes : (editState == null ? void 0 : editState.published) || null, fieldActions = (0, import_react.useMemo)(
    ...
    (blurredPath) => {
      disableBlurRef.current || (setFocusPath(EMPTY_ARRAY$x), focusPathRef.current !== EMPTY_ARRAY$x && (focusPathRef.current = EMPTY_ARRAY$x, onFocusPath == null ? void 0 : onFocusPath(EMPTY_ARRAY$x)));
    },
  ...
  const handleChange = (0, import_react.useCallback)((event) => patchRef.current(event), []), closeInspector = (0, import_react.useCallback)(
    (closeInspectorName) => {
      ...
      if (currentInspector) {
        if (inspector) {
          const result = ((_a = inspector.onClose) == null ? void 0 : _a.call(inspector, { params })) ?? { params };
    ...
    (nextInspectorName, paneParams) => {
      ...
      currentInspector && (currentParams = (((_a = nextInspector.onClose) == null ? void 0 : _a.call(nextInspector, { params: currentParams })) ?? {
  ...
  const setOpenPath = (0, import_react.useCallback)(
    ...
    (nextFocusPath, payload) => {
      setFocusPath(nextFocusPath), (0, import_react_fast_compare.default)(focusPathRef.current, nextFocusPath) || (setOpenPath(nextFocusPath.slice(0, -1)), focusPathRef.current = nextFocusPath, onFocusPath == null ? void 0 : onFocusPath(nextFocusPath)), updatePresenceThrottled(nextFocusPath, payload);
    },
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    return ((_a = item.params) == null ? void 0 : _a.layout) ? {
      ...
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$x)
    } : { ...item, selected: false };
  });
};
...
var PaneContainer = (0, import_react.memo)(function(props) {
  const { index, isSelected, pane: pane2, paneKey } = props, { name: parentSourceName } = useSource(), {
    ...
    initialValueTemplates = EMPTY_ARRAY$x,
    menuItemGroups,
    menuItems,
    options
  } = pane2, { defaultOrdering = EMPTY_ARRAY$x, filter: filter2 } = options, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source, typeName = (0, import_react.useMemo)(() => {
    const staticTypes = findStaticTypesInFilter(filter2, params);
    return (staticTypes == null ? void 0 : staticTypes.length) === 1 ? staticTypes[0] : null;
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-TQP5VAQ4.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-HA4D6XKC.js.map
